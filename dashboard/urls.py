...
urlpatterns = [
    ...
    path('api/students/<int:student_id>/courses/enroll/', StudentCoursesView.as_view(), name='student-course-enroll'),
    path('api/students/<int:student_id>/courses/unenroll/', StudentCoursesView.as_view(), name='student-course-unenroll'),
